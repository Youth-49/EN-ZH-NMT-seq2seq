...
if __name__ == '__main__':
    ...
    parser.add_argument('--freq_cutoff', type=int, default=2)
    parser.add_argument('--vocab_file', type=str, default='vocab.json')
    args = parser.parse_args()
    vars(args)['model'] = 'vocab'

    print(f'read in source sentences: {args.train_src}')
    print(f'read in target sentences: {args.train_tgt}')
    ...
    print(f'generated vocabulary, source {len(vocab.src)} words, target {len(vocab.tgt)} words')
